...
# GGMW9 CITY — hidden fictional Underground game layer
CITY_UNDERGROUND_CATEGORY_NAME = "🌑・THE UNDERGROUND"
CITY_UNDERGROUND_CHANNEL_NAMES = {
...
CITY_UNDERGROUND_INVITE_HOURS = 24
CITY_UNDERGROUND_CREW_INVITE_HOURS = 24
CITY_UNDERGROUND_MISSION_COOLDOWN_MINUTES = 45
CITY_UNDERGROUND_HEAT_DECAY_HOURS = 6
CITY_UNDERGROUND_CREW_CREATE_COST = 4000       # $40
CITY_UNDERGROUND_HEIST_PREP_COST = 5000        # $50
CITY_UNDERGROUND_HEIST_COOLDOWN_HOURS = 120    # 5 days
CITY_UNDERGROUND_HEIST_MIN_CREW = 3
CITY_UNDERGROUND_HEIST_MIN_REP = 200
CITY_UNDERGROUND_HEIST_MIN_TREASURY = 25000   # $250 reserve required
CITY_UNDERGROUND_MARKET_TAX_BPS = 650          # 6.5%
CITY_UNDERGROUND_CREW_HEIST_SHARE_BPS = 2500   # 25% to crew vault

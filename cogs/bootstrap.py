...
if globals().get("_GGMW9_COMPONENT_EXEC", False):
    ...
    MARRIAGE_CENTER_CHANNEL_ID = 1536602981359685724   # ← حط هنا ID ديال channel "العدول" (كليك يمين ع الشانيل → Copy Channel ID) — فيها غادي يتصاوبو البانلات ديال الزواج/الصداقة

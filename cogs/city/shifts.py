...
TASKS = {
    ...
    "tutor": [("📚 تلميذ ما فهمش الدرس؛ شنو الأحسن؟", ["نعاود نشرح بطريقة أسهل", "نلوم التلميذ", "نكمل بلا ما نتأكد"], 0)],
    "clinic_assistant": [("🩺 عضو جا محتاج مساعدة؛ شنو الأول؟", ["نسمعو ونوجهو للخدمة المناسبة", "نعطيه جواب بلا ما نفهمو", "نتجاهلو"], 0)],
    "fitness_coach": [("🏋️ عضو باغي يبدا؛ شنو الأول؟", ["نقيّم المستوى ونبني برنامج مناسب", "نعطيه برنامج صعيب بزاف مباشرة", "نخليه وحدو"], 0)],
    "legal_advisor": [("⚖️ عضو عندو سؤال على قوانين المدينة؛ شنو تدير؟", ["نشرح القوانين المطبقة بحياد", "نأخذ صف طرف بلا دليل", "نتجاهل السؤال"], 0)],
    "tax_inspector": [("🏛️ مشروع تأخر فخلاص الضريبة؛ شنو الأول؟", ["نبعث تذكير واضح بالمهلة", "نحجز الأرض مباشرة بلا تنبيه", "نتجاهل الملف"], 0)],
    "security_guard": [("🛡️ كاين نقاش سخن بين عضوين؛ شنو الأول؟", ["نهدن الوضع ونبلغ الإدارة", "ندخل نتصارع", "نتفرج بلا تدخل"], 0)],
    "journalist": [("📰 خبر جديد فالمدينة؛ شنو قبل النشر؟", ["نتأكد من المصدر والمعلومة", "ننشر مباشرة بلا تأكد", "نختلق تفاصيل"], 0)],
    "architect": [("📐 مشروع بناء جديد؛ شنو الأول؟", ["نخطط المساحة والتكلفة قبل البداية", "نبدا البناء بلا تخطيط", "ننسخ تصميم آخر بلا تعديل"], 0)],
}

...
CAREERS = {
    ...
    "tutor": {
        "emoji":"📚","sector":"education","business_id":"ggmw9_academy",
        "name":{"darija":"أستاذ خصوصي","en":"Private Tutor","fr":"Professeur particulier"},
        "desc":{"darija":"دروس دعم وتوجيه دراسي للأعضاء.","en":"Support lessons and academic guidance for members.","fr":"Cours de soutien et orientation pour les membres."},
        "skills":{"communication":4,"organization":3,"leadership":2},"styles":{"people":3,"solo":1},
        "pay_cycle":"daily","hourly":700,"service_worker_share_bps":1500,"work_days":[0,1,2,3,4,5,6],
        "ranks":ranks("متدرب","أستاذ خصوصي","أستاذ محترف","مشرف الأكاديمية","مدير الأكاديمية"),
        "benefits":{"shop_discount_by_rank":[0,0,1,2,2],"bank_bps_by_rank":[0,0,0,1,1]},
    },
    "clinic_assistant": {
        "emoji":"🩺","sector":"health","business_id":"ggmw9_clinic",
        "name":{"darija":"مساعد العيادة الافتراضية","en":"Virtual Clinic Assistant","fr":"Assistant clinique virtuelle"},
        "desc":{"darija":"استقبال وتوجيه الأعضاء نحو الخدمة المناسبة.","en":"Welcome and route members to the right service.","fr":"Accueillir et orienter les membres vers le bon service."},
        "skills":{"customer":4,"organization":4,"problem_solving":2},"styles":{"people":3,"technical":1},
        "pay_cycle":"daily","hourly":750,"service_worker_share_bps":1200,"work_days":[0,1,2,3,4,5,6],
        "ranks":ranks("متدرب","مساعد عيادة","ممرض معتمد","مشرف العيادة","مدير العيادة"),
        "benefits":{"shop_discount_by_rank":[0,0,1,1,2],"bank_bps_by_rank":[0,0,0,0,1]},
    },
    "fitness_coach": {
        "emoji":"🏋️","sector":"health","business_id":"ggmw9_gym",
        "name":{"darija":"مدرب رياضي","en":"Fitness Coach","fr":"Coach sportif"},
        "desc":{"darija":"برامج تمارين وتحفيز رياضي للأعضاء.","en":"Workout plans and motivation for members.","fr":"Programmes sportifs et motivation pour les membres."},
        "skills":{"communication":3,"leadership":3,"organization":2},"styles":{"people":4,"active":3},
        "pay_cycle":"commission","hourly":400,"service_worker_share_bps":6500,"work_days":[0,1,2,3,4,5,6],
        "ranks":ranks("متدرب","مدرب رياضي","مدرب محترف","Senior Coach","Gym Director"),
        "benefits":{"shop_discount_by_rank":[0,1,2,3,4],"bank_bps_by_rank":[0,0,0,1,1]},
    },
    "legal_advisor": {
        "emoji":"⚖️","sector":"legal","business_id":"ggmw9_legal_office",
        "name":{"darija":"مستشار قانوني","en":"Legal Advisor","fr":"Conseiller juridique"},
        "desc":{"darija":"شرح قوانين المدينة وتوجيه الأعضاء بحياد.","en":"Explain city rules and guide members impartially.","fr":"Expliquer les règles de la ville et conseiller les membres."},
        "skills":{"communication":4,"problem_solving":4,"finance":2},"styles":{"technical":3,"people":2},
        "pay_cycle":"weekly","hourly":900,"service_worker_share_bps":1000,"work_days":[0,1,2,3,4],
        "ranks":ranks("متدرب","مستشار قانوني","مستشار محترف","Senior Advisor","Legal Director"),
        "benefits":{"shop_discount_by_rank":[0,0,1,2,2],"bank_bps_by_rank":[1,1,2,2,3]},
    },
    "tax_inspector": {
        "emoji":"🏛️","sector":"civic","business_id":"ggmw9_city_hall",
        "name":{"darija":"مفتش الضرائب","en":"Tax Inspector","fr":"Inspecteur des impôts"},
        "desc":{"darija":"متابعة أداء ضرائب الأراضي والمشاريع لصالح خزينة المدينة.","en":"Track land and business tax payments for the city treasury.","fr":"Suivre les impôts fonciers et commerciaux pour le trésor de la ville."},
        "skills":{"finance":4,"organization":4,"problem_solving":2},"styles":{"technical":3,"solo":2},
        "pay_cycle":"weekly","hourly":850,"service_worker_share_bps":0,"work_days":[0,1,2,3,4],
        "ranks":ranks("متدرب","مفتش ضرائب","مفتش أول","مشرف الجباية","مدير الخزينة"),
        "benefits":{"shop_discount_by_rank":[0,0,0,1,2],"bank_bps_by_rank":[1,1,2,3,3]},
    },
    "security_guard": {
        "emoji":"🛡️","sector":"civic","business_id":"ggmw9_security",
        "name":{"darija":"حارس أمن المدينة","en":"City Security Guard","fr":"Agent de sécurité"},
        "desc":{"darija":"مراقبة الهدوء داخل فضاءات المدينة والتبليغ عند الحاجة.","en":"Keep city spaces calm and report issues when needed.","fr":"Veiller au calme des espaces et signaler les incidents."},
        "skills":{"organization":3,"problem_solving":3,"leadership":2},"styles":{"solo":3,"active":2},
        "pay_cycle":"daily","hourly":700,"service_worker_share_bps":0,"work_days":[0,1,2,3,4,5,6],
        "ranks":ranks("متدرب","حارس أمن","حارس أول","مشرف الأمن","مدير الأمن"),
        "benefits":{"shop_discount_by_rank":[0,0,1,1,2],"bank_bps_by_rank":[0,0,0,1,1]},
    },
    "journalist": {
        "emoji":"📰","sector":"media","business_id":"ggmw9_news",
        "name":{"darija":"صحفي المدينة","en":"City Journalist","fr":"Journaliste de la ville"},
        "desc":{"darija":"تغطية أخبار المدينة والمشاريع الجديدة بمصداقية.","en":"Cover city news and new ventures reliably.","fr":"Couvrir l'actualité de la ville avec fiabilité."},
        "skills":{"content":4,"communication":4,"creativity":2},"styles":{"creative":3,"people":2},
        "pay_cycle":"commission","hourly":400,"service_worker_share_bps":6500,"work_days":[0,1,2,3,4,5,6],
        "ranks":ranks("متدرب","صحفي","صحفي محترف","Senior Journalist","Editor-in-Chief"),
        "benefits":{"shop_discount_by_rank":[0,0,2,3,4],"bank_bps_by_rank":[0,0,0,1,1]},
    },
    "architect": {
        "emoji":"📐","sector":"technical","business_id":"ggmw9_architecture",
        "name":{"darija":"مهندس معماري","en":"Architect","fr":"Architecte"},
        "desc":{"darija":"تصاميم وتخطيط لمشاريع البناء الجديدة داخل المدينة.","en":"Design and planning for new construction projects.","fr":"Conception et planification des nouveaux chantiers."},
        "skills":{"design":4,"tech":3,"problem_solving":3},"styles":{"technical":4,"creative":2},
        "pay_cycle":"commission","hourly":450,"service_worker_share_bps":6500,"work_days":[0,1,2,3,4,5,6],
        "ranks":ranks("متدرب","مهندس معماري","مهندس محترف","Senior Architect","Studio Director"),
        "benefits":{"shop_discount_by_rank":[0,1,2,3,4],"bank_bps_by_rank":[0,0,0,1,1]},
    },
}
...
SECTOR_NAMES = {
    ...
    "education":{"emoji":"📚","darija":"التعليم","en":"Education","fr":"Éducation"},
    "health":{"emoji":"🩺","darija":"الصحة واللياقة","en":"Health & Fitness","fr":"Santé & Forme"},
    "legal":{"emoji":"⚖️","darija":"القانون","en":"Legal","fr":"Juridique"},
    "civic":{"emoji":"🏛️","darija":"خدمات المدينة","en":"City Services","fr":"Services municipaux"},
}
